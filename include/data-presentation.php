...
prepareMsg('validDate', "<strong>The date could not be changed.</strong><br>The date must be in the format <strong>YYYY-MM-DD</strong> and between <strong>" . $maxDateISO . "</strong> and <strong>" . $maxDateISO . "</strong>.");
